...
- ☑ Tungsten HIP multi-node (same 768³ / 10 steps): 16 GCD job 21760377 median 222 ms (eff 24%, slower than 8 GCD); 32 GCD job 21760378 median 103 ms (eff 26%). Pins: `lumi-standard-g-tungsten-hip-{16,32}gcd-release-768.json`. Off-node does not help this grid; 8 GCDs is the useful limit.
