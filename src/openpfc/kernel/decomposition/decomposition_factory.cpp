...
#include <mpi.h>
#include <openpfc/kernel/data/domain.hpp> // For Domain types
...
// Domain-based factory functions (M12: Primary interface)
...
// World-based factory functions (deprecated for M12, retained for compatibility)
