...
| Understand what each application solves | [Applications catalog (research)](https://github.com/ahojukka5/research/blob/master/articles/openpfc-applications/index.qmd) | [Applications overview](user_guide/applications.md) |
