...
| AluminumNew | [`apps/aluminumNew/aluminumNew.json`](../../apps/aluminumNew/aluminumNew.json), `aluminumNew.toml` | `SpectralETDSession<AluminumPhysics, …>` (`constant` + app-registered `seed_grid_fcc`). |
