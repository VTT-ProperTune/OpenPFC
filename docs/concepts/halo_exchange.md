...
| `Full3D()`  |  26  | axes + 12 edges + 8 corners                  | 3D mixed second derivatives; default for `HaloExchange` Full and `FullPaddedDeviceHalo`. |
