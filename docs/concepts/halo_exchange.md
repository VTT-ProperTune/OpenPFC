...
- Integration (HIP): `test_full_padded_device_halo_hip.cpp` — HIP twin of the CUDA 26-direction device-halo cases (`pfc::hip::FullPaddedDeviceHalo`). Compiling under HIP is an M3 gate; executing on a GPU is M-LUMI.
