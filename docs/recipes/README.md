...
| Recipe | Goal |
|--------|------|
| [`recipe_run_example_simulator.md`](recipe_run_example_simulator.md) | Run `05_simulator` with MPI (library stack smoke test) |
| [`recipe_spectral_app_json.md`](recipe_spectral_app_json.md) | Run the **tungsten** spectral `App` with a JSON input from the repo |
| [`recipe_artifacts_vtk_or_binary.md`](recipe_artifacts_vtk_or_binary.md) | Produce VTK or binary field output and open or post-process it |
