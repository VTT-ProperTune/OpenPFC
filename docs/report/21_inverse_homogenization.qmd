...
| 21964843 | 3-D $64^3$ inverse, 1 rank: 12 steps, 6 solves/step, 7.7–4.7 s/step, VmHWM 224 MB. 8 ranks: 1.05–0.62 s/step. Genuine $n_z=64$ spinodal, not a 2-D extrusion. CPU/`standard` only. |
