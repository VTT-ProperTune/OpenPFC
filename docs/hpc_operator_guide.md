...
| One-page dependency / CI tooling summary | [`dependency_matrix.md`](dependency_matrix.md) |
...
| Binary field format (no header) | [`binary_field_io_spec.md`](binary_field_io_spec.md) |
| Offline analysis | [`postprocess_binary_fields.md`](postprocess_binary_fields.md) |
...
- [`personas.md`](personas.md) — “I run on a cluster” track  
