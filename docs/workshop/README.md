...
Structured **time-boxed** modules for teaching OpenPFC. The same material exists elsewhere (`tutorials/`, `getting_started/`); this hub orders it for a **multi-session course**.
