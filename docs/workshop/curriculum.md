...
|---------|----------|-------------|
| 0:00–0:20 | Motivation: PFC, FFT scaling, where OpenPFC sits | [`README.md`](../../README.md) (intro), [`spectral_stack.md`](../spectral_stack.md) |
| 0:20–1:10 | Modules, GCC/Open MPI, HeFFTe prefix, `cmake` | [`INSTALL.md`](../../INSTALL.md), [`dependency_matrix.md`](../dependency_matrix.md) |
...
| Segment | Activity | Primary doc |
|---------|----------|-------------|
| 0:00–0:15 | Recap: spectral stack, `App` vs bare `examples/` | [`spectral_stack.md`](../spectral_stack.md), [`applications.md`](../applications.md) |
...
| 1:15–2:00 | Config sections: domain, fields, `plan_options` skim | [`spectral_app_config_reference.md`](../spectral_app_config_reference.md), [`configuration.md`](../configuration.md) |
...
| Segment | Activity | Primary doc |
|---------|----------|-------------|
| 0:00–0:30 | Slurm vs interactive; `srun`/`mpirun` | [`hpc_operator_guide.md`](../hpc_operator_guide.md), [`tutorials/hpc_slurm_day_one.md`](../tutorials/hpc_slurm_day_one.md) |
| 0:30–1:30 | MPI-IO checklist; restarts | [`mpi_io_layout_checklist.md`](../mpi_io_layout_checklist.md), [`operator_playbooks.md`](../operator_playbooks.md) |
| 1:30–2:30 | Enable profiling in JSON; interpret export | [`performance_profiling.md`](../performance_profiling.md), [`profiling_export_schema.md`](../profiling_export_schema.md) |
| 2:30–3:00 | GPU path decision (if site has GPUs) | [`gpu_path_decision.md`](../gpu_path_decision.md), [`tutorials/gpu_app_quickstart.md`](../tutorials/gpu_app_quickstart.md) |
