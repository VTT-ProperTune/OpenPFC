 ...
 * @brief Reproducible single Fourier-mode initial condition for Cahn–Hilliard.
 *
 * @details
 * Sets \f$c(\mathbf x)=c_0+A\cos(2\pi n_x x/L_x+2\pi n_y y/L_y+2\pi n_z z/L_z)\f$.
 * JSON `"type": "cosine_mode"`. Integer mode counts keep the field periodic.
 */
...
public:
  ...
  [[nodiscard]] double c0() const { return m_c0; }
