...
alloy_dendrite_growth --seed2-radius=8 --crystal-angle=0.2 \
                      --crystal-angle2=-0.2 --csv=results/bicrystal.csv
...
`a_s` as the isothermal dendrite. `--crystal-angle` is that rotation in
