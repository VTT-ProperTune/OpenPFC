...
CMake wires subdirectories from [`apps/CMakeLists.txt`](CMakeLists.txt) in this order: `tungsten`, `aluminumNew`, `allen_cahn`, `heat3d`, `wave2d`, `kobayashi`, `alloy_pf_directional`.
