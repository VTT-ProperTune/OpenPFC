...
CMake wires subdirectories from [`apps/CMakeLists.txt`](CMakeLists.txt): `common`, then HeFFTe-gated `tungsten` / `aluminumNew`, then `allen_cahn`, `heat3d`, `wave2d`, `kobayashi`, `alloy_pf_directional`.
