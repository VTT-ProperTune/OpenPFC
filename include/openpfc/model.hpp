...
private:
  FFT &m_fft;                       ///< Reference to the FFT object used by the model
  RealFieldSet m_real_fields;       ///< Collection of real-valued fields associated with the model
  ComplexFieldSet m_complex_fields; ///< Collection of complex-valued fields associated with the model

public:
  const bool rank0; ///< Flag indicating if the current MPI rank is 0 (useful for rank-specific operations)
