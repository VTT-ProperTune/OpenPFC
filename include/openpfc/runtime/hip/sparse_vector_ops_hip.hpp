...
/**
 * @file sparse_vector_ops_hip.hpp
 * @brief HIP implementation of gather/scatter for SparseVector (device pointers)
 *
 * Declarations for gather_hip_impl and scatter_hip_impl. Only included and
