 ...
 *        `pfc::data::Field`-layout device buffer.
 *
 * @details
...
/**
 * @brief 26-direction halo exchanger for a `pfc::data::Field` device buffer.
 *
...
public:
   ...
   *               `pfc::data::Field` layout (outer extents `(nx+2hw, ny+2hw, nz+2hw)`).
