 ...
 *
 * Host Faces and Full MPI (`HostFacesHalo`, `HostFullHalo`) live in this
 * header. Persistent still composes `HostPersistentFaces` until that
 * backend is inlined. Device `HaloExchange<CUDASpace/HIPSpace>` lives in
