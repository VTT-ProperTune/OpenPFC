 ...
 * single axpy in field operators. The underlying field types
 * (`pfc::data::Field<double>`, `pfc::sim::DuField<G, Eval>`, …) each provide
 * a matching `operator*(double, …)` returning this proxy.
 *
