...
message(STATUS " OpenPFC_ENABLE_HEFFTE            = ${OpenPFC_ENABLE_HEFFTE}")
...
if(OpenPFC_HIP_AVAILABLE)
  ...
  if(OpenPFC_ENABLE_HIP_SPECTRAL)
    message(STATUS " OpenPFC_ENABLE_HIP_SPECTRAL      = ON (✅ ROCm HeFFTe/rocFFT available)")
  else()
    message(STATUS " OpenPFC_ENABLE_HIP_SPECTRAL      = OFF (ROCm HeFFTe missing)")
    message(STATUS "   HIP finite-difference/kernel apps may still build; HIP spectral FFT")
    message(STATUS "   runtime, Tungsten HIP spectral targets, and HIP FFT JSON helpers are skipped.")
  endif()
endif()
if(OpenPFC_CUDA_AVAILABLE)
  ...
  if(OpenPFC_MPI_CUDA_AWARE)
    if(OPENPFC_GPU_AWARE_MPI_CUDA_PROBE_SKIPPED STREQUAL "cross-compiling")
    ...
    elseif(OPENPFC_OMPI_CUDA_MPI_AWARE_OK)
      message(STATUS " OpenPFC CUDA MPI probe          = OK (MPIX_Query_cuda_support)")
    elseif(OPENPFC_MPIX_QUERY_CUDA_SUPPORT_COMPILES)
      message(
        STATUS
          " OpenPFC CUDA MPI probe          = failed (MPIX_Query_cuda_support != 1; see warnings)")
    endif()
  endif()
endif()
message(STATUS "-------------------------------------------------------------")
