...
if(OpenPFC_ENABLE_CODE_COVERAGE)
  ...
  if(LCOV_EXECUTABLE AND GENHTML_EXECUTABLE AND GCOV_EXECUTABLE)
    ...
    set(_OpenPFC_cov_missing "")
    if(NOT LCOV_EXECUTABLE)
      list(APPEND _OpenPFC_cov_missing "lcov")
    endif()
    if(NOT GENHTML_EXECUTABLE)
      list(APPEND _OpenPFC_cov_missing "genhtml")
    endif()
    if(NOT GCOV_EXECUTABLE)
      list(APPEND _OpenPFC_cov_missing "gcov")
    endif()
    list(JOIN _OpenPFC_cov_missing ", " _OpenPFC_cov_missing_joined)
    message(STATUS
      "📊 Coverage flags are enabled, but report tools are missing (${_OpenPFC_cov_missing_joined}); "
      "targets coverage/coverage-clean are not created.")
    message(STATUS
      "   Install lcov (includes genhtml); gcov ships with GCC. Examples: "
      "apt install lcov · dnf install lcov (Fedora; on RHEL 8 use EPEL first) · brew install lcov")
  endif()
endif()
