...
int main() {
  ...
  auto world2d =
      pfc::domain::create_world(GridSize({128, 128, 1}), PhysicalOrigin({0.0, 0.0, 0.0}),
  ...
  auto world1d =
      pfc::domain::create_world(GridSize({256, 1, 1}), PhysicalOrigin({0.0, 0.0, 0.0}),
  ...
  auto world_offset =
      pfc::domain::create_world(GridSize({100, 100, 50}), PhysicalOrigin({-5.0, -5.0, 0.0}),
  ...
  std::cout << std::string(60, '=') << "\n";
  {
    auto w = pfc::domain::create_world(GridSize({50, 50, 50}), PhysicalOrigin({0.0, 0.0, 0.0}),
